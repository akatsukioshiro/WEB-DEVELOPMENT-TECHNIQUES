...
* Currently supports the following features :
  * DIV Creation.
    - Click DIV button in Navbar to create DIV.
  * BUTTON Creation in DIV.
  * DIV Text Edit.
  * DIV Drag and Reposition.
  * DIV Resize.
  * Download Output as *.html* file.
    - Click SUBMIT button in Navbar to download output file.
* Shortcut Keys and Feautures :
  * **d/D + Double Click**
    - 'D' for Drag.
    - Drag and Place DIV wherever you want.
    - Repeat the same on DIV to stop this feature. 
  * **r/R + Double Click**
    - 'R' for Resize.
    - This is CSS Resize feature.
    - Use 'Right-Bottom' Corner of DIV to resize the DIV.
    - Repeat the same on DIV to stop this feature.
  * **b/B + Double Click**
    - 'B' for Button.
    - Opens an Alert, Enter the number of Buttons Required in it.
    - These Buttons will appear inside DIV.
    - Repeat the same on DIV to stop this feature.
  * **Ctrl + Single Click**
    - This is to edit TEXT in DIV.
